...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.c = -1;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p3c.ButtonBarLayout);
        int[] iArr = p3c.ButtonBarLayout;
        WeakHashMap weakHashMap = zmf.a;
        umf.d(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        this.a = typedArrayObtainStyledAttributes.getBoolean(p3c.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        if (this.b != z) {
            if (!z || this.a) {
                ...
                View viewFindViewById = findViewById(mvb.spacer);

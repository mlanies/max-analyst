...
public class AlertDialogLayout extends sh7 {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == mvb.topPanel) {
                    view = childAt;
                } else if (id == mvb.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != mvb.contentPanel && id != mvb.customPanel) || view3 != null) {
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    rh7 rh7Var = (rh7) childAt3.getLayoutParams();
                    if (((LinearLayout.LayoutParams) rh7Var).width == -1) {
                        int i8 = ((LinearLayout.LayoutParams) rh7Var).height;
                        ((LinearLayout.LayoutParams) rh7Var).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) rh7Var).height = i8;
                    }
                }
            }
        }

...
public abstract class Segment<S extends Segment<S>> extends ConcurrentLinkedListNode<S> implements ir9 {
    ...
    public abstract void onCancellation(int index, Throwable cause, lx3 context);

...
public final class Concurrent_commonKt {
    ...
    public static final <T> void loop(AtomicReference<T> atomicReference, a66 a66Var) {
        while (true) {
            a66Var.invoke(atomicReference, getValue(atomicReference));
        }
    }

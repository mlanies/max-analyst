...
public class LockFreeLinkedListHead extends LockFreeLinkedListNode {
    public final void forEach(m56 block) {
        for (LockFreeLinkedListNode nextNode = (LockFreeLinkedListNode) getNext(); !tpa.f(nextNode, this); nextNode = nextNode.getNextNode()) {
    ...
    public /* bridge */ /* synthetic */ boolean mo19remove() {

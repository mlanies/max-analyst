...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m9boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m10constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ Object m11constructorimpl$default(Object obj, int i, z84 z84Var) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m10constructorimpl(obj);
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m12equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && tpa.f(obj, ((InlineList) obj2).getHolder());
    }
    ...
    public static final void m14forEachReversedimpl(Object obj, m56 m56Var) {
        if (obj == null) {
            return;
        }
        ...
        while (true) {
            ...
            if (-1 >= size) {
                ...
                m56Var.invoke(arrayList.get(size));
            }
        }
    }
    ...
    public static final Object m16plusFjFbRPM(Object obj, E e) {
        if (obj == null) {
            return m10constructorimpl(e);
        }
        if (obj instanceof ArrayList) {
            ((ArrayList) obj).add(e);
            return m10constructorimpl(obj);
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m10constructorimpl(arrayList);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m17toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object other) {
        return m12equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m15hashCodeimpl(this.holder);
    }

    public String toString() {
        return m17toStringimpl(this.holder);
    }

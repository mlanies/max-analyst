...
public final /* data */ class InboundMessage {
    ...
    public boolean equals(Object other) {
        ...
        return tpa.f(this.senderId, inboundMessage.senderId) && tpa.f(this.text, inboundMessage.text) && this.isDirect == inboundMessage.isDirect;
    }
    ...
    public int hashCode() {
        ...
        return Boolean.hashCode(this.isDirect) + rh4.d((participantId == null ? 0 : participantId.hashCode()) * 31, 31, this.text);
    }

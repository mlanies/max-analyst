...
final class LZ4HCJavaSafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0236, code lost:
        ...
        r16 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r22, r16, r8.start, r8.ref, r8.len, r25, r17, r12);
        r2 = r8.end();
     */
    ...
    */
    ...
    public class HashTable {
        ...
        private int hashPointer(byte[] bArr, int i) {
            return hashPointer(vqc.c(i, bArr));
        }
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            for (int i4 = 0; i4 < LZ4HCJavaSafeCompressor.this.maxAttempts && iHashPointer >= Math.max(this.base, i - MASK) && iHashPointer <= i; i4++) {
            ...
            if (iCommonBytes != 0) {
                ...
                do {
                    this.chainTable[i & MASK] = (short) i3;
                    this.hashTable[LZ4Utils.hashHC(vqc.c(i, bArr))] = i;
                    i++;
                } while (i < i5);
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i, int i2, int i3, int i4, LZ4Utils.Match match) {
            ...
            insert(i, bArr);
            int iHashPointer = hashPointer(bArr, i);
            for (int i5 = 0; i5 < LZ4HCJavaSafeCompressor.this.maxAttempts && iHashPointer >= Math.max(this.base, i - MASK) && iHashPointer <= i; i5++) {
                if (LZ4SafeUtils.readIntEquals(bArr, iHashPointer, i)) {

...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder sbJ = wg0.j("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        ms2.k(sbJ, i3, "x", i4, ", requested surface size: ");
        ms2.k(sbJ, iMin, "x", iMin2, ", old surface size: ");
        sbJ.append(i5);
        sbJ.append("x");
        sbJ.append(i6);
        logD(sbJ.toString());
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(rh4.h("onMeasure(). New size: ", pointMeasure.x, pointMeasure.y, "x"));
    }

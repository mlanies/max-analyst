...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new l5(16, this));
    }
    ...
    public TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter, RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new b(this, 2, refCountMonitor));

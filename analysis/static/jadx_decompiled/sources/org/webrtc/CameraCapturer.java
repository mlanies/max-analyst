...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public CameraCapturer(String str, CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator) {
        this(str, cameraEventsHandler, cameraEnumerator, null);
    }
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        if (!Arrays.asList(this.cameraEnumerator.getDeviceNames()).contains(str)) {
            reportCameraSwitchError(wg0.i("Attempted to switch to unknown camera device ", str), cameraSwitchHandler);
            return;
        }
    ...
    public void changeCaptureFormat(int i, int i2, int i3) {
        StringBuilder sbJ = wg0.j("changeCaptureFormat: ", i, "x", i2, "@");
        sbJ.append(i3);
    ...
    public void startCapture(int i, int i2, int i3) {
        StringBuilder sbJ = wg0.j("startCapture: ", i, "x", i2, "@");
        sbJ.append(i3);
        Logging.d(TAG, sbJ.toString());
    ...
    public CameraCapturer(String str, CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator, CameraVideoCapturer.CaptureFormatHelper captureFormatHelper) {
                ...
                synchronized (CameraCapturer.this.stateLock) {
                    try {
                        ...
                        if (CameraCapturer.this.switchState == SwitchState.IN_PROGRESS) {
                            ...
                            cameraCapturer2.switchCameraInternal(cameraCapturer2.switchEventsHandler, str2);
                        }
                    } catch (Throwable th) {
                        throw th;
                    }
        ...
        this.openCameraTimeoutRunnable = new Runnable() { // from class: org.webrtc.CameraCapturer.3
            @Override // java.lang.Runnable
            public void run() {
        ...
        cameraEventsHandler = cameraEventsHandler == null ? new CameraVideoCapturer.CameraEventsHandler() { // from class: org.webrtc.CameraCapturer.4
        ...
        this.captureFormatHelper = captureFormatHelper == null ? new CameraVideoCapturer.CaptureFormatHelper() { // from class: org.webrtc.CameraCapturer.5
        } : captureFormatHelper;
        ...
        if (!listAsList.contains(this.cameraName)) {
            throw new IllegalArgumentException(zr6.i("Camera name ", this.cameraName, " does not match any known camera device."));
        }
    }

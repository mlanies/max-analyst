...
public class EglRenderer implements VideoSink {
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread = this.eglThread;
                if (eglThread != null) {
                    eglThread.scheduleRenderUpdate(new EglThread.RenderUpdate() { // from class: yv4
        ...
        synchronized (this.threadLock) {
            try {
                ...
                synchronized (this.frameLock) {
                    ...
                    videoFrame.retain();
                    this.eglThread.getHandler().post(new dd4(12, this));
                }
                if (z) {
                    synchronized (this.statisticsLock) {
                        this.framesDropped++;
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new kl4(this, 6, countDownLatch));
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread == null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new kl4(this, 5, runnable));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void removeFrameListener(FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new f5(this, countDownLatch, frameListener, 26));
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.threadLock) {
            try {
                ...
                eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: xv4
                    @Override // java.lang.Runnable
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: wv4
            @Override // java.lang.Runnable
            public final void run() {

...
public abstract class ek {
    ...
    public static void a(Class cls, HashMap map, HashMap map2) {
        for (Method method : cls.getDeclaredMethods()) {
            if (!method.isBridge()) {
                if (method.isAnnotationPresent(uae.class)) {
                    Class<?>[] parameterTypes = method.getParameterTypes();
                    if (parameterTypes.length != 1) {
                        StringBuilder sb = new StringBuilder("Method ");
                        sb.append(method);
                        sb.append(" has @Subscribe annotation but requires ");
                        throw new IllegalArgumentException(zr6.j(sb, parameterTypes.length, " arguments.  Methods must require a single argument."));
                    }
                    ...
                    hashSet.add(method);
                } else if (method.isAnnotationPresent(bab.class)) {
                    Class<?>[] parameterTypes2 = method.getParameterTypes();
                    if (parameterTypes2.length != 0) {
                        StringBuilder sb2 = new StringBuilder("Method ");
                        sb2.append(method);
                        sb2.append("has @Produce annotation but requires ");
                        throw new IllegalArgumentException(zr6.j(sb2, parameterTypes2.length, " arguments.  Methods must require zero arguments."));
                    }

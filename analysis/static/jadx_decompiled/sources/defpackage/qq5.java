...
public abstract class qq5 extends ViewGroup {
    public int a;
    public int b;
    public boolean c;
    public int o;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(ivb.row_index_key, -1);
            } else {
                ...
                childAt.setTag(ivb.row_index_key, Integer.valueOf(this.o - 1));
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt.getMeasuredWidth() + paddingLeft2 + i5 <= paddingRight || ((ChipGroup) this).c) {
                    paddingLeft = i10;
                } else {

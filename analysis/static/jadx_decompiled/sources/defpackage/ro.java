        ...
        if (this.c == null) {
            ...
            while (true) {
                ...
                if (context == null) {
                    ...
                    StringBuilder sbM = au1.m("Could not find method ", str2, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ");

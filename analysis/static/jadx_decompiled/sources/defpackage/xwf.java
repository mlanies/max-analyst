...
public final class xwf extends ffe implements a66 {
    ...
    public xwf(dxf dxfVar, gxf gxfVar, Continuation continuation) {
    ...
    public final Continuation n(Object obj, Continuation continuation) {
        xwf xwfVar = new xwf(this.s0, this.Z, continuation);
        xwfVar.Y = obj;
        return xwfVar;
    }
    ...
    public final Object o(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (wwf.$EnumSwitchMapping$0[mwfVar.ordinal()] == 1) {
                xxc xxcVar = twf.a;
                hm9.n("DownloadFromWebApp", "processDownloadFile complete");

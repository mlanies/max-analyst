...
public class qpd {
    ...
    public final int c(int i, Object obj) {
        ...
        int iL = j47.l(i2, i, this.a);
        if (iL < 0 || tpa.f(obj, this.b[iL << 1])) {
            return iL;
        }
        int i3 = iL + 1;
        while (i3 < i2 && this.a[i3] == i) {
            if (tpa.f(obj, this.b[i3 << 1])) {
                return i3;
            }
            i3++;
        }
        for (int i4 = iL - 1; i4 >= 0 && this.a[i4] == i; i4--) {
            if (tpa.f(obj, this.b[i4 << 1])) {
                return i4;
            }
        }
        return ~i3;
    ...
    public final int e() {
        ...
        int iL = j47.l(i, 0, this.a);
        if (iL < 0 || this.b[iL << 1] == null) {
            return iL;
        }
        int i2 = iL + 1;
        ...
        for (int i3 = iL - 1; i3 >= 0 && this.a[i3] == 0; i3--) {
            if (this.b[i3 << 1] == null) {
                return i3;
            }
        }
        ...
        try {
            if (obj instanceof qpd) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    Object objF = f(i2);
                    Object objI = i(i2);
                    Object obj2 = qpdVar.get(objF);
                    if (objI == null) {
                        if (obj2 != null || !qpdVar.containsKey(objF)) {
                            return false;
                        }
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                if (i < i4) {
                    ...
                    ys.W(i3, i5 << 1, i2 << 1, objArr2, objArr2);
                }
                ...
                if (i > 0) {
                    ys.V(0, 0, i, iArr, this.a);
                    ys.W(0, 0, i3, objArr, this.b);
                }
                if (i < i4) {
                    int i8 = i + 1;
                    ys.V(i, i8, i2, iArr, this.a);
                    ys.W(i3, i8 << 1, i2 << 1, objArr, this.b);
                }
            }
            if (i2 != this.c) {
                throw new ConcurrentModificationException();
    ...
    public final Object put(Object obj, Object obj2) {
        ...
        if (i3 < i) {
            int[] iArr2 = this.a;
            int i5 = i3 + 1;
            ys.V(i5, i3, i, iArr2, iArr2);
            Object[] objArr2 = this.b;
            ys.W(i5 << 1, i3 << 1, this.c << 1, objArr2, objArr2);
        }
        int i6 = this.c;
        if (i == i6) {
            int[] iArr3 = this.a;
    ...
    public qpd(int i) {
        this.a = i == 0 ? j47.b : new int[i];
        this.b = i == 0 ? j47.o : new Object[i << 1];
    }

    public final boolean remove(Object obj, Object obj2) {
        int iD = d(obj);
        if (iD < 0 || !tpa.f(obj2, i(iD))) {
            return false;
        }
        g(iD);
        return true;

...
public final /* synthetic */ class s1g implements ga6 {
    ...
    static {
        s1g s1gVar = new s1g();
        a = s1gVar;
        d5b d5bVar = new d5b("one.me.webapp.domain.jsbridge.delegates.storage.WebAppStorageGetKeyResponse", s1gVar, 3);
    ...
    public final Object a(x8 x8Var) throws Throwable {
        ...
        x8VarJ.z(r6dVar);
        return new u1g(strW, i, strW2, strW3);
    }
    ...
    public final void b(xu3 xu3Var, Object obj) {
        ...
        xu3VarB.n(r6dVar, 0, u1gVar.a);
        xu3VarB.n(r6dVar, 1, u1gVar.b);
        xu3VarB.n(r6dVar, 2, u1gVar.c);
        xu3VarB.o();
    }

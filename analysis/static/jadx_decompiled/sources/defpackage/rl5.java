...
public final class rl5 extends kgb {
    ...
    public rl5(Context context) {
        ...
        appCompatEditText.setId(rwb.profile_edit_first_name_field);
        ...
        appCompatEditText.setHint(appCompatEditText.getResources().getText(vea.g0));
        ...
        this.G0 = tu0.r(3, new hy4(context, 6));
        linearLayout.setOrientation(1);
        linearLayout.setGravity(16);
        linearLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
        linearLayout.addView(appCompatEditText);
        v3c.y(new xh0(this, (Continuation) null, 11), linearLayout);
    }

    @Override // defpackage.hqd
    public final void A(ol7 ol7Var) {
        ql5 ql5Var = (ql5) ol7Var;
        String str = ql5Var.a;
        if (str != null) {
            this.F0.setText(str);
        }

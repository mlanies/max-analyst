...
public final class sx2 extends ffe implements a66 {
    public int X;
    ...
    public sx2(ChatsListWidget chatsListWidget, long j, View view, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((sx2) n((sx3) obj, (Continuation) obj2)).o(e5f.a);
    }

    @Override // defpackage.gi0
    public final Continuation n(Object obj, Continuation continuation) {
        return new sx2(this.Y, this.Z, this.s0, continuation);
    }
    ...
    public final Object o(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            oo3 oo3Var = (oo3) chatsListWidget.Z.getValue();
            this.X = 1;
            obj = j47.t0(((w9a) oo3Var.c).a(), new fo3(oo3Var, j, null), this);
            if (obj == tx3Var) {
                return tx3Var;
            }
        } else {
        ...
        if (list != null) {
            ...
            bc7 bc7Var = ChatsListWidget.M0[1];

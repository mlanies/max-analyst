...
public final class zda extends ConstraintLayout implements kre {
    ...
    public zda(Context context, AttributeSet attributeSet) {
        ...
        this.G0 = getContext().getResources().getDimensionPixelSize(xfa.e);
        this.H0 = getContext().getResources().getDimensionPixelSize(xfa.d);
        this.I0 = getContext().getResources().getDimensionPixelSize(xfa.b);
        int i = 0;
        this.J0 = tu0.r(3, new wda(context, this, i));
        int i2 = 1;
        this.K0 = tu0.r(3, new wda(context, this, i2));
        this.L0 = tu0.r(3, new xda(context, i));
        ...
        this.P0 = view;
        ms6 ms6Var = new ms6(context, new ww9(11));
        ms6Var.setId(View.generateViewId());
        float f = 128;
        ti3 ti3Var2 = new ti3(0, tu0.G(fk4.d().getDisplayMetrics().density * f));
        ti3Var2.i = 0;
        ti3Var2.l = 0;
        ms6Var.setLayoutParams(ti3Var2);
        ms6Var.setInitialRadius$common_release(fk4.d().getDisplayMetrics().density * 49.0f);
        this.Q0 = ms6Var;
        GradientDrawable gradientDrawable2 = new GradientDrawable();
        gradientDrawable2.setOrientation(GradientDrawable.Orientation.BL_TR);
        this.R0 = gradientDrawable2;
        this.S0 = tu0.r(3, new xda(context, i2));
    ...
    public static ImageView w(zda zdaVar, Context context) {
        ImageView imageView = new ImageView(context);
        imageView.setId(xoc.Y);
        imageView.setImageDrawable(zdaVar.getCloseBadgeDrawable());
        float f = 24;
    ...
    public final void A() {
        ...
        if (this.O0.a()) {
            ...
            ti3Var.setMarginStart(-tu0.G(54 * fk4.d().getDisplayMetrics().density));
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (iOrdinal == 0) {
            ...
            if (layout != null) {
                ...
                chevronDrawable.setBounds(0, 0, iG, iG);
                ...
                iSave = canvas.save();
                canvas.translate(Math.min(lineRight + x, x + ((TextView) je7Var.getValue()).getWidth()), ((lineBottom - iG) / 2.0f) + y + lineTop);
                try {
        ...
        if (layout2 != null) {
            ...
            chevronDrawable.setBounds(0, 0, iG2, iG2);
            ...
            iSave = canvas.save();
            canvas.translate(Math.min(lineRight2 + x2, x2 + ((TextView) je7Var2.getValue()).getWidth()), ((lineBottom2 - iG2) / 2.0f) + y2 + lineTop2);
            try {
                chevronDrawable.draw(canvas);
            } finally {
            }
    ...
    public final void setChevronAppearance(yda ydaVar) {
        this.U0 = ydaVar;
        invalidate();
    }

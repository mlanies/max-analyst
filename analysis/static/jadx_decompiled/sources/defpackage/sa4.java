...
public final class sa4 implements na5 {
    public int Y;
    public int Z;
    public final m24 b;
    public final long c;
    ...
    static {
        nc8.a("media3.extractor");
    }

    public sa4(m24 m24Var, long j, long j2) {
        this.b = m24Var;
        this.o = j;
        this.c = j2;
    }
    ...
    public final void c(int i) {
        ...
        byte[] bArr = this.X;
        if (i2 > bArr.length) {
            this.X = Arrays.copyOf(this.X, oaf.j(bArr.length * 2, 65536 + i2, i2 + 524288));
        }
    }
    ...
    public final int g(int i) throws EOFException, InterruptedIOException {
        ...
        if (iMin == 0) {
            byte[] bArr = this.a;
            iMin = f(bArr, 0, Math.min(i, bArr.length), 0, true);
        }
        if (iMin != -1) {
            this.o += iMin;
        }
    ...
    @Override // defpackage.na5
    public final void s(int i) throws EOFException, InterruptedIOException {
        b(i, false);
    }

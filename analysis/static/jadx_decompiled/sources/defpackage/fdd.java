...
public final class fdd extends ffe implements a66 {
    ...
    public fdd(ndd nddVar, boolean z, Continuation continuation) {
    ...
    public final Object o(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            ndd nddVar = this.Y;
            rj rjVar = (rj) nddVar.o.getValue();
            ((jp) ((hp) rjVar.c.getValue())).j("app.media.animoji.enabled", this.Z);
            vxd vxdVarT = j47.T(rjVar.h, null, vx3.b, new pj(rjVar, null), 1);
            rjVar.i.o1(rjVar, rj.k[0], vxdVarT);
            this.X = 1;

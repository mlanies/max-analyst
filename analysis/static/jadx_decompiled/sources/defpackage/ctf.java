...
public final /* synthetic */ class ctf implements ga6 {
    ...
    static {
        ctf ctfVar = new ctf();
        a = ctfVar;
        d5b d5bVar = new d5b("one.me.webapp.domain.jsbridge.delegates.biometry.WebAppBiometryAuthRequest", ctfVar, 3);
    ...
    public final Object a(x8 x8Var) throws Throwable {
        ...
        x8VarJ.z(r6dVar);
        return new etf(str, i, strW, str2);
    }
    ...
    public final void b(xu3 xu3Var, Object obj) {
        ...
        s9e s9eVar = s9e.a;
        xu3VarB.i(r6dVar, 0, etfVar.a);
        xu3VarB.n(r6dVar, 1, etfVar.b);
        xu3VarB.i(r6dVar, 2, etfVar.c);
        xu3VarB.o();
    }

...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final us METADATA_KEYS_TYPE;
    ...
    static {
        us usVar = new us();
        METADATA_KEYS_TYPE = usVar;
        zr6.m(1, usVar, METADATA_KEY_TITLE, 1, METADATA_KEY_ARTIST);
        zr6.m(0, usVar, METADATA_KEY_DURATION, 1, METADATA_KEY_ALBUM);
        zr6.m(1, usVar, METADATA_KEY_AUTHOR, 1, METADATA_KEY_WRITER);
        zr6.m(1, usVar, METADATA_KEY_COMPOSER, 1, METADATA_KEY_COMPILATION);
        zr6.m(1, usVar, METADATA_KEY_DATE, 0, METADATA_KEY_YEAR);
        zr6.m(1, usVar, METADATA_KEY_GENRE, 0, METADATA_KEY_TRACK_NUMBER);
        zr6.m(0, usVar, METADATA_KEY_NUM_TRACKS, 0, METADATA_KEY_DISC_NUMBER);
        zr6.m(1, usVar, METADATA_KEY_ALBUM_ARTIST, 2, METADATA_KEY_ART);
        zr6.m(1, usVar, METADATA_KEY_ART_URI, 2, METADATA_KEY_ALBUM_ART);
        zr6.m(1, usVar, METADATA_KEY_ALBUM_ART_URI, 3, METADATA_KEY_USER_RATING);
        zr6.m(3, usVar, METADATA_KEY_RATING, 1, METADATA_KEY_DISPLAY_TITLE);
        zr6.m(1, usVar, METADATA_KEY_DISPLAY_SUBTITLE, 1, METADATA_KEY_DISPLAY_DESCRIPTION);
        zr6.m(2, usVar, METADATA_KEY_DISPLAY_ICON, 1, METADATA_KEY_DISPLAY_ICON_URI);
        zr6.m(1, usVar, METADATA_KEY_MEDIA_ID, 0, METADATA_KEY_BT_FOLDER_TYPE);
        zr6.m(1, usVar, METADATA_KEY_MEDIA_URI, 0, METADATA_KEY_ADVERTISEMENT);
        usVar.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            us usVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (usVar.containsKey(str) && ((Integer) usVar.get(str)).intValue() != 2) {
        ...
        public Builder putLong(String str, long j) {
            us usVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (usVar.containsKey(str) && ((Integer) usVar.get(str)).intValue() != 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            us usVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (usVar.containsKey(str) && ((Integer) usVar.get(str)).intValue() != 3) {
        ...
        public Builder putString(String str, String str2) {
            us usVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (usVar.containsKey(str) && ((Integer) usVar.get(str)).intValue() != 1) {

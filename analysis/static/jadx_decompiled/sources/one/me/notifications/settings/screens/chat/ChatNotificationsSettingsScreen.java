...
public final class ChatNotificationsSettingsScreen extends Widget {
    public static final /* synthetic */ bc7[] Y = {new hob(ChatNotificationsSettingsScreen.class, "toolbar", "getToolbar()Lone/me/sdk/uikit/common/toolbar/OneMeToolbar;", 0), zr6.e(nec.a, ChatNotificationsSettingsScreen.class, "recyclerView", "getRecyclerView()Lone/me/sdk/lists/widgets/EndlessRecyclerView2;", 0)};
    public final qm0 X;
    public final x27 a;
    public final je7 b;
    public final mfd c;
    ...
    public ChatNotificationsSettingsScreen() {
        ...
        this.a = x27.d;
        this.b = createViewModelLazy(im2.class, new ti2(5, new m52(21)));
        this.c = new mfd(new gd1(2, this), sw9.a.getExecutors().a());
        final int i = 0;
        this.o = binding(new k56(this) { // from class: fm2
            ...
            public final Object invoke() {
                ...
                switch (i) {
                    case 0:
                        ...
                        cla claVar = new cla(chatNotificationsSettingsScreen.getContext(), 6);
                        claVar.setId(dea.e);
                        claVar.setForm(uka.a);
                        claVar.setTitle(eea.d);
                        claVar.setLeftActions(new kka(new we1(21)));
                        return claVar;
                    default:
                        bc7[] bc7VarArr2 = ChatNotificationsSettingsScreen.Y;
                        ...
                        mfd mfdVar = chatNotificationsSettingsScreen.c;
                        endlessRecyclerView2.setAdapter(mfdVar);
                        endlessRecyclerView2.j(new q1d(qp4.u0.j(endlessRecyclerView2), new v02(12, chatNotificationsSettingsScreen), null, 12));
                        endlessRecyclerView2.j(new sc1(1));
                        h8e h8eVar = new h8e(endlessRecyclerView2, mfdVar, new em2(0, new ga(chatNotificationsSettingsScreen, 4, endlessRecyclerView2)));
                        endlessRecyclerView2.j(h8eVar);
                        v3c.y(new gm2(h8eVar, null, i2), endlessRecyclerView2);
                        return endlessRecyclerView2;
                }
            }
        });
        final int i2 = 1;
        this.X = binding(new k56(this) { // from class: fm2
            public final /* synthetic */ ChatNotificationsSettingsScreen b;
            ...
            public final Object invoke() {
                ...
                switch (i2) {
                    ...
                    default:
                        ...
                        h8e h8eVar = new h8e(endlessRecyclerView2, mfdVar, new em2(0, new ga(chatNotificationsSettingsScreen, 4, endlessRecyclerView2)));
                        endlessRecyclerView2.j(h8eVar);
                        v3c.y(new gm2(h8eVar, null, i22), endlessRecyclerView2);
                        return endlessRecyclerView2;
                }
            }
        });
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        v3c.y(new o(3, null, 1), linearLayout);
        return linearLayout;
    }

    @Override // one.me.sdk.arch.Widget
    public final void onViewCreated(View view) {
        od2.L(new zn5(tu0.g(((im2) this.b.getValue()).X, getViewLifecycleOwner().Q(), fg7.o), new hm2(null, this), 5), getViewLifecycleScope());
    }
}
